...
//Set Answers
answer1 = "1. you should look right, left and right";
answer2 = "2. you should be able recognise the main road";
answer3 = "3. everyone will always have equal priority";
answer4 = "4. you should never assume that you have priority";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Observation at junctions is of prime importance. The DVSA publication ‘the official guide to learning to drive’ states, specifically, that at unmarked junctions:</h4>
