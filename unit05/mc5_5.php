        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if ($canswer == $password) {
                  ...
                  if( isset( $_SESSION['counter5_mc'] ) ) {
                     $_SESSION['counter5_mc'] += 1;
                  }else {
                     $_SESSION['counter5_mc'] = 1;
                  }
                }
...
//Set Answers
answer1 = "1. carefully move them to somewhere comfortable, supporting their neck";
answer2 = "2. reassure them that help is on the way and not move them";
answer3 = "3. ignore them because if they are conscious they are probably OK";
answer4 = "4. make them lie in the recovery position";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">If someone is injured at the scene of an accident and they tell you that they are unable to move, you should:</h4>
