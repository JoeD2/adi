...
//Set Answers
answer1 = "1. below the engine";
answer2 = "2. below the floor in the boot";
answer3 = "3. above the engine";
answer4 = "4. in the fuel tank";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Engine lubricating oil is stored in the sump. The sump is situated:</h4>
