...
//Set Answers
answer1 = "1. take care when parking in cycle lanes";
answer2 = "2. never cross cycle lanes";
answer3 = "3. take special care when crossing cycle lanes";
answer4 = "4. only drive in cycle lanes in an emergency";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The DVSA publication ‘the official guide to learning to drive’ states that drivers should:</h4>
