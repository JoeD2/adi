...
//Set Answers
answer1 = "1. sound your horn";
answer2 = "2. give way";
answer3 = "3. abort the turn";
answer4 = "4. change to a lower gear";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">If a pedestrian is crossing the road, into which you intend to turn, you should always:</h4>
