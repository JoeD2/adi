...
//Set Answers
answer1 = "1. keep your speed down to less than 30 mph";
answer2 = "2. keep your engine speed low by driving in a high gear";
answer3 = "3. stop the car and switch off the engine";
answer4 = "4. drive carefully to the next exit if you are on a motorway";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">If the oil warning light comes on during normal driving, you should:</h4>
