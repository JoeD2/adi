...
<head>
    <meta charset="UTF-8">
    <title>Unit 5 - Comprehension</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <p>A useful way of explaining the speed to your learners (when discussing reactions in an emergency) is to use metres per second (or feet per second for older people) rather than miles per hour. Doing this gives a more dramatic explanation of what speed really means. List the speed equivalents for 20 mph, a 30 mph, 40 mph and 70 mph as metres per second.</p>
