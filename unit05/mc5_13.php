...
//Set Answers
answer1 = "1. is always making good use of mirrors and so cannot fail for mirror use";
answer2 = "2. might not be making good use of mirrors and could fail for mirror use";
answer3 = "3. must have adjusted the mirror correctly";
answer4 = "4. will impress the examiner";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">A learner driver who looks at the mirrors frequently during a driving test:</h4>
