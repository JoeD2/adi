...
//Set Answers
answer1 = "1. the engine would run too cold";
answer2 = "2. the engine would overheat";
answer3 = "3. the ignition light would come on";
answer4 = "4. the engine would immediately start misfiring";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The likely effect of a car engine radiator leak would be that:</h4>
