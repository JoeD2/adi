...
//Set Answers
answer1 = "1. drive quickly to increase air circulation around the brake discs";
answer2 = "2. apply light pressure to the brake pedal while driving slowly";
answer3 = "3. drive in second gear until full braking efficiency is regained";
answer4 = "4. complete several safe stops using cadence braking";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">After driving through floodwater your brakes might be ineffective. To correct this you should:</h4>
