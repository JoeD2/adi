...
//Set Answers
answer1 = "1. always use the mirrors";
answer2 = "2. use mirrors effectively at all times";
answer3 = "3. use mirrors after signalling";
answer4 = "4. only use the mirrors in pairs";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The DVSA publication ‘the official guide to learning to drive’ recommends that drivers should:</h4>
