...
//Set Answers
answer1 = "1. always give a signal";
answer2 = "2. always look round over both shoulders";
answer3 = "3. check all relevant blind spots";
answer4 = "4. look round over the right shoulder only";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When moving off, before starting to move it is necessary to check all of your mirrors and:</h4>
