...
//Set Answers
answer1 = "1. by turning the head slightly to the left";
answer2 = "2. without moving the head";
answer3 = "3. by leaning slightly forward in the seat";
answer4 = "4. from the normal driving (seating) position";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Interior mirrors should be adjusted so that the driver can get the best view behind:</h4>
