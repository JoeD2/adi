...
//Set Answers
answer1 = "1. one interior and one exterior mirror on the driver’s side";
answer2 = "2. one interior and one exterior mirror on the passenger’s side";
answer3 = "3. one interior and two exterior mirrors";
answer4 = "4. there is no minimum requirement";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">All new cars must be fitted with:</h4>
