...
//Set Answers
answer1 = "1. use first gear";
answer2 = "2. use second gear";
answer3 = "3. use the most appropriate gear";
answer4 = "4. never use third gear";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When moving away downhill, you should normally:</h4>
