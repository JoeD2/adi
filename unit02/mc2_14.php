...
//Set Answers
answer1 = "1. stroke of the pistons";
answer2 = "2. opening and closing of the valves";
answer3 = "3. ignition timing";
answer4 = "4. camber of the wheels";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The camshaft controls the:</h4>
