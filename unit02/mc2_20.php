        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if ($canswer == $password) {
                  ...
                  if( isset( $_SESSION['counter2_mc'] ) ) {
                     $_SESSION['counter2_mc'] += 1;
                  }else {
                     $_SESSION['counter2_mc'] = 1;
                  }
                }
...
//Set Answers
answer1 = "1. interrupt the learner’s answer as soon as he/she goes wrong";
answer2 = "2. praise the correct element and then offer a clear explanation";
answer3 = "3. tell the learner that he/she needs to try a bit harder";
answer4 = "4. ignore the correct element and offer a clear explanation";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">If, after asking a question, you get an answer that is not fully correct you should normally:</h4>
        ...
        <div class="form-group text-center">
            ...
            <input type="button" class="btn btn-default" onclick="location.href='mc'+u_num+'_res.php';" value="Finish">
        </div>
    </div>
