    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if ($canswer == $password) {
                  if( isset( $_SESSION['counter2_rs'] ) ) {
                     $_SESSION['counter2_rs'] += 1;
                  }else {
                     $_SESSION['counter2_rs'] = 1;
                  }
                }
...
//Set Answers
answer1 = "1. maximum recommended speed";
answer2 = "2. minimum recommended speed";
answer3 = "3. end of minimum speed limit";
answer4 = "4. end of recommended speed limit";
