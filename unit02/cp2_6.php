...
<body>
    ...
    <div class="wrapper">
        ...
        <p>Write a brief paragraph, as if talking to a learner, explaining the dangers of ‘mascots’ (furry dice, etc.) that are hung from the interior driver’s mirror? (Hint: Hang something on your mirror to gauge the effect.)</p>
        <a href="http://www.theaa.com/motoring_advice/news/dangling-dangers.html">The AA - Mascots</a>
