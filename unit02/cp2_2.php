...
<body>
    ...
    <div class="wrapper">
        ...
        <p>Metaphor can be useful when explaining some concepts. Think of, and briefly explain, a metaphor that you could use to describe the pressure that is used on the brake pedal when stopping. (Hint: Use your own imagination or experience - you are unlikely to find a direct reference to answer this.)</p>
