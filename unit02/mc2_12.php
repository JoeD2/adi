...
//Set Answers
answer1 = "1. reset the mirror for normal use";
answer2 = "2. slow down to allow your eyes time to readjust to the light";
answer3 = "3. check the door mirrors to ensure that the road is clear behind";
answer4 = "4. slow down if there is a closely following vehicle";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">After using an interior anti-dazzle mirror you must always remember to:</h4>
