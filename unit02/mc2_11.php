...
//Set Answers
answer1 = "1. get into the habit of glancing in the mirror every 5 seconds";
answer2 = "2. get into the habit of glancing in the mirror frequently";
answer3 = "3. get into the habit of glancing into the mirror all the time";
answer4 = "4. only use the mirror when approaching hazards";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The Official DVSA Guide to driving, ‘Driving the essential skills’ recommends that you should:</h4>
