...
//Set Answers
answer1 = "1. should always be checked before changing speed or position";
answer2 = "2. should often be checked before changing speed or position";
answer3 = "3. need only be checked before changing speed or position when there are vehicles behind";
answer4 = "4. should always be used in pairs when changing speed or position";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When teaching a new driver about mirror use, you should advise that mirrors:</h4>
