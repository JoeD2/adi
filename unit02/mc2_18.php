...
//Set Answers
answer1 = "1. the oil level";
answer2 = "2. the operation of the horn and the brakes";
answer3 = "3. the brake fluid level";
answer4 = "4. the condition of the spare wheel";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Items to be checked by all drivers every day include:</h4>
