...
//Set Answers
answer1 = "1. must be fitted with a dipping device";
answer2 = "2. must be clean and in a serviceable condition";
answer3 = "3. must not be tinted";
answer4 = "4. must be repaired within 24 hours if damaged";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">In relation to rear view mirrors, the law specifically states that:</h4>
