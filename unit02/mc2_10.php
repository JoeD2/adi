...
//Set Answers
answer1 = "1. to the nearside";
answer2 = "2. to the offside";
answer3 = "3. directly behind";
answer4 = "4. when driving an unfamiliar vehicle";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The Official DVSA Guide to driving, ‘Driving the essential skills’, states that interior mirrors should be adjusted to give the best possible view with minimal head movement, especially:</h4>
