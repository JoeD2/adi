...
<body>
    ...
    <div class="wrapper">
        ...
        <p>What are the likely consequences of not checking mirror adjustment from the driver’s normal seating position?
          (Hint: Try this for yourself, but please do not drive the car. Simply consider the consequences based on what you discover when moving back to your normal seating position.)</p>
