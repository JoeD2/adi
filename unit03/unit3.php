...
Clutch / Gears: Gear changing.
  ...
  <div class="menu-wrap">
    <ul class="menu">
        <li>
            <a href ="" onclick="location.href='/unit03/mc'+u_num+'_1.php';return false;">Multiple Choice</a>
        </li>
        ...
        <li>
            <a href ="" onclick="location.href='/unit03/cp'+u_num+'_'+lanswer+'.php';return false;">Comprehension</a>
        </li>
