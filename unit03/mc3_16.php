...
//Set Answers
answer1 = "1. prevent the car from skidding";
answer2 = "2. increase the available grip on the road";
answer3 = "3. help you to maintain steering control";
answer4 = "4. always help you to stop quicker than ordinary brakes";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When driving on snow or ice, anti-lock brakes will:</h4>
