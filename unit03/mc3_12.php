        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if ($canswer == $password) {
                  ...
                  if( isset( $_SESSION['counter3_mc'] ) ) {
                     $_SESSION['counter3_mc'] += 1;
                  }else {
                     $_SESSION['counter3_mc'] = 1;
                  }
                }
...
//Set Answers
answer1 = "1. adding the thinking distance and the braking distance together";
answer2 = "2. dividing the thinking distance by the braking distance";
answer3 = "3. subtracting the thinking distance from the braking distance";
answer4 = "4. multiplying the thinking distance by the braking distance";
</script>
...
<head>
    <meta charset="UTF-8">
    <title>Unit 3 - Multiple Choice</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Overall stopping distance is calculated by:</h4>
