...
//Set Answers
answer1 = "1. steer to the left";
answer2 = "2. steer to the right";
answer3 = "3. grip the wheel as tightly as possible";
answer4 = "4. do nothing with the steering wheel";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When driving around a roundabout in a front wheel drive car, you feel the rear of your vehicle start to skid to the left. You should:</h4>
