...
//Set Answers
answer1 = "1. make a provisional driving licence application";
answer2 = "2. be in physical possession of a provisional driving licence";
answer3 = "3. pass the driving theory test";
answer4 = "4. book lessons with a DVSA Approved Driving Instructor";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Before driving on a public road, new drivers must:</h4>
