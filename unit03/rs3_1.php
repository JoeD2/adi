    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if ($canswer == $password) {
                  if( isset( $_SESSION['counter3_rs'] ) ) {
                     $_SESSION['counter3_rs'] += 1;
                  }else {
                     $_SESSION['counter3_rs'] = 1;
                  }
                }
...
//Set Answers
answer1 = "1. have a legal requirement to stop";
answer2 = "2. should always stop but it is not a legal requirement";
answer3 = "3. only need to stop if the patrol is allowing children to cross";
answer4 = "4. only have a legal requirement to stop if the warden is operating on a recognised crossing type (Zebra, Puffin, etc.)";
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When you see this sign...</h4>
        <br>
        <iframe frameborder="0" scrolling="no" width="150%" height="50%"
   src="pics/1.jpg" name="imgbox" id="imgbox">
   <p>iframes are not supported by your browser.</p>
        ...
        <div class="form-group">
            <input type="button" class="btn btn-default" onclick="location.href='rs'+u_num+'_'+(n_num)+'.php';" style="margin-left: 25%;" value="Next">
        </div>
    </div>
