...
//Set Answers
answer1 = "1. that you must move one lane to the left";
answer2 = "2. that you must move to the hard shoulder";
answer3 = "3. that you must not proceed further in the affected lane";
answer4 = "4. that you must leave the motorway at the next exit";
...
<body>
   ...
   src="pics/6.jpg" name="imgbox" id="imgbox">
   <p>iframes are not supported by your browser.</p>
        ...
        <div class="form-group">
          ...
          <input type="button" class="btn btn-default" onclick="location.href='rs'+u_num+'_res.php';" value="Finish">
        </div>
    </div>
