...
//Set Answers
answer1 = "1. for use on motorways only";
answer2 = "2. to provide a quieter driving environment";
answer3 = "3. for increased economy";
answer4 = "4. to improve acceleration";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Some cars are fitted with a six-speed gearbox, sixth gear is provided:</h4>
