...
//Set Answers
answer1 = "1. The Official DVSA Guide to Driving, the essential skills";
answer2 = "2. the Highway Code";
answer3 = "3. your car's handbook";
answer4 = "4. the police manual, Roadcraft";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Guidance on recommended gear change speeds can be found in:</h4>
