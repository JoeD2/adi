...
//Set Answers
answer1 = "1. a clutchless gear change";
answer2 = "2. a downward gear change which omits an intermediate gear only";
answer3 = "3. an upward gear change which omits an intermediate gear only";
answer4 = "4. any gear change which omits an intermediate gear";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The term selective gear change is used to describe:</h4>
