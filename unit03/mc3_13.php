...
//Set Answers
answer1 = "1. be applied to assist the rear brakes";
answer2 = "2. only be used on dry road surfaces";
answer3 = "3. not be touched";
answer4 = "4. be helpful in rear wheel drive cars";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The Official DVSA Guide to Driving, the essential skills states that when stopping in an emergency the parking brake should:</h4>
