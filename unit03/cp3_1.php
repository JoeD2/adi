...
<body>
    ...
    <div class="wrapper">
        ...
        <p>Briefly explain the dangers of using the instructional command 'Stop!' for normal stops. In addition, what alternative instruction might you use in normal stopping/parking situations?</p>
