...
<body>
    ...
    <div class="wrapper">
        ...
        <p>Some driving instructors use teaching terminology that is not commonly used by the majority – why might it be useful to know different terminology? (Example: biting point is common for the clutch but some instructors might use driving point or holding point.)</p>
