...
//Set Answers
answer1 = "1. the front of the car";
answer2 = "2. the obstructions";
answer3 = "3. the road well ahead";
answer4 = "4. the rear mirror";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When teaching learners about steering to approach obstructions in the road, you should advise them to look at:</h4>
