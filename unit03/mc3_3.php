...
//Set Answers
answer1 = "1. importance of quick actions";
answer2 = "2. relevance to the driving test only";
answer3 = "3. fact that it will take a long time to learn";
answer4 = "4. reasons for doing it";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When explaining a skill, or driving procedure to a learner, you should always stress the:</h4>
