...
//Set Answers
answer1 = "1. the throttle";
answer2 = "2. the power pedal";
answer3 = "3. the gas pedal";
answer4 = "4. economy pedal";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The Official DVSA Guide to Driving, the essential skills’ states that the accelerator pedal can also be called:</h4>
