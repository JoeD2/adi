...
Law: Penalty points, Seatbelts, ADI Register<br>
  ...
  <div class="menu-wrap">
    <ul class="menu">
        <li>
            <a href ="" onclick="location.href='/unit04/mc'+u_num+'_1.php';return false;">Multiple Choice</a>
        </li>
        ...
        <li>
            <a href ="" onclick="location.href='/unit04/cp'+u_num+'_'+lanswer+'.php';return false;">Comprehension</a>
        </li>
