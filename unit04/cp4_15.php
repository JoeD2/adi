...
<head>
    <meta charset="UTF-8">
    <title>Unit 4 - Comprehension</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <p>The answer to multiple-choice question 15 the minimum period before requalifying as an ADI would be ‘four years from the start of the ban’ after a one-year disqualification –however, in reality, the period would probably be longer as the ADI Registrar also has to consider whether the person is ‘fit and proper’. Given that the minimum period after a one year ban is four years, how long would it be before an instructor could resume work if the driving ban was for only one day?</p>
