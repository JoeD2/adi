...
//Set Answers
answer1 = "1. reduce your speed";
answer2 = "2. use your mirrors";
answer3 = "3. select the appropriate gear";
answer4 = "4. signal early";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When you see a junction ahead the first thing you should do is:</h4>
