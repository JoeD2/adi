...
//Set Answers
answer1 = "1. moving into position early";
answer2 = "2. flashing your headlights to give way";
answer3 = "3. moving off quickly";
answer4 = "4. always stopping to give way";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The Official DVSA Guide to Driving, ‘Driving the essential skills’, states that, when emerging at junctions to turn right, you can help other drivers by:</h4>
