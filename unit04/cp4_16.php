...
<body>
    ...
    <div class="wrapper">
        ...
        <p>Consider whether or not it should be the role of the driving instructor to explain, in simple terms, about the fixed penalty point system? Write a brief paragraph explaining your thoughts.</p>
