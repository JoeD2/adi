...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Under the ‘totting up’ system, the maximum number of penalty points that a driver, who has held a full licence for longer than three years, can get in a three year period without incurring a compulsory driving ban is:</h4>
