...
//Set Answers
answer1 = "1. five years from the start of the ban";
answer2 = "2. four years from the start of the ban";
answer3 = "3. three years from the start of the ban";
answer4 = "4. one year from the start of the ban mph";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">Certain requirements must be met before a person is eligible for entry on to the Register of Approved Driving Instructors. If a driving instructor receives a one-year driving ban, he/she will have to re-qualify and will be disqualified from resuming work as an instructor for a minimum of:</h4>
