...
//Set Answers
answer1 = "1. the parents or legal guardians";
answer2 = "2. the child";
answer3 = "3. the driver";
answer4 = "4. the police";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The legal responsibility, for ensuring that a child under 14 years of age is suitably restrained by using a seatbelt, lies with:</h4>
