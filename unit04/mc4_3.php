...
//Set Answers
answer1 = "1. reduced by use of brakes";
answer2 = "2. reduced by use of gears";
answer3 = "3. adjusted as necessary";
answer4 = "4. reduced in good time";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">When teaching a new learner to implement a systematic approach to junctions, you should advise that speed must always be:</h4>
