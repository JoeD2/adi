...
//Set Answers
answer1 = "1. the sight-line zone";
answer2 = "2. the zone of vision";
answer3 = "3. the obstacle zone";
answer4 = "4. the danger zone";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The driver’s view to the front of the vehicle, when approaching junctions, is referred to as:</h4>
