    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if ($canswer == $password) {
                  if( isset( $_SESSION['counter4_rs'] ) ) {
                     $_SESSION['counter4_rs'] += 1;
                  }else {
                     $_SESSION['counter4_rs'] = 1;
                  }
                }
...
//Set Answers
answer1 = "1. accompanied horses and riders prohibited";
answer2 = "2. horse drawn vehicle prohibited";
answer3 = "3. route for horse drawn vehicles";
answer4 = "4. horse drawn vehicles crossing";
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">This sign means..</h4>
        <br>
