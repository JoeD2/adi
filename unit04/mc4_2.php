...
//Set Answers
answer1 = "1. MSM PSL LADA";
answer2 = "2. MSP PGL LAD";
answer3 = "3. MSL PSL LODA";
answer4 = "4. MSPSG LOAD";
</script>
...
<body>
    ...
    <div class="wrapper">
        ...
        <h4 class="question">The DVSA recommends that a systematic approach should be made to all hazards. The system suggested is:</h4>
